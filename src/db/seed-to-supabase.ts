...
async function main() {
  ...
  for (const row of areas) {
    await pg.query(
      'INSERT INTO delivery_areas (name, fee, active) VALUES ($1, $2, $3)',
  ...
  for (const row of timeSlots) {
    await pg.query(
      'INSERT INTO time_slots (label, sort_order, max_capacity, active) VALUES ($1, $2, $3, $4)',
  ...
  console.log(`✅ Migration complete! ${totalRows} total rows seeded.`);
